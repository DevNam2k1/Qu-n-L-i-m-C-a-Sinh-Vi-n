...
<form action="{{URL::to('/update-point/'.$score->student_id)}}" method="POST">
  {{ csrf_field()}}
  <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="number" name="final_2st" value="{{$score->final_1st}} min="0" max="10" class="form-control" id="exampleInputPassword1" placeholder="Điểm Thi Lại Final">
        </div> 
         @endif
