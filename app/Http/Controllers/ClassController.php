...
class ClassController extends Controller
{
    ...
    public function class_list(){
      ...
      ->join('tbl_major','tbl_major.major_id','=','tbl_class.major_id')->get();
    ...
    public function edit_class($class_id){
      ...
      $manager_class = view('admin.edit_class')->with('edit_class',$edit_class)->with('lecturers_list',$lecturers_list)->with('major_list',$major_list);
